  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 text-white">
        <h2 className="text-3xl sm:text-3xl lg:text-5xl font-semibold mb-4">
          How can we help you?
        </h2>
        <p className="text-lg sm:text-lg lg:text-xl mb-6">
          Get advice from Guangxi Solar experts today!
        </p>
        <Link
          href="/contact"
