        ...
        <div className="w-full bg-white py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center gap-8">
                <div className="lg:w-1/2 flex flex-col gap-[10px]">
                    <h2 className="text-3xl font-bold mb-2">Smart Manufacturing at Yangtze Solar</h2>
                    ...
                    <div className="border-r-4 pr-2 border-green-600 mb-6">
                        <p className="text-gray-600 text-base leading-relaxed">
                            Under the CHINT Group, Yangtze Solar leverages cutting-edge smart manufacturing to revolutionize photovoltaic cell and module production. Since 2006, we have integrated advanced automation, AI-driven quality control, and sustainable practices into our intelligent manufacturing facilities. <br />
                ...
                <div className="lg:w-1/2">
                    <Image
                        ...
                        alt="Yangtze Solar Smart Manufacturing Facility"
                        width={700}
                        height={400}
